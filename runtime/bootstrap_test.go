...
func TestRunBootstrapHello(t *testing.T) {
	...
	if hello.Artifact.ApplicationID != "grove-test-app" || hello.Artifact.RuntimeVersion != "v0.1.0-dev" || hello.Artifact.ConfigRevision != groveshop.DefaultConfigRevision || hello.Artifact.ClusterID != "local" || hello.Artifact.NodeZone != "local" {
