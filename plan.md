...
- [ ] 2. Implement the local Client and Call path.
...
- [ ] 3. Route Orders to Inventory through Grove.
...
- [ ] 4. Prove local invocation and the one-Grovlet flow.
